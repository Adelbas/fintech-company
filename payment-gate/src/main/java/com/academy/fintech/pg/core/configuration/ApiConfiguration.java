...
import com.academy.fintech.invoker.ApiClient;
...
@Configuration
@EnableConfigurationProperties({ MerchantProviderRestClientProperty.class, OriginationGrpcClientProperty.class})
